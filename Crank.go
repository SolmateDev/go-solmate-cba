...
func (inst *Crank) SetPcVaultAccount(pcVault ag_solanago.PublicKey) *Crank {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(pcVault)
	return inst
}
...
func (inst *Crank) SetValidatorPipelineAccount(validatorPipeline ag_solanago.PublicKey) *Crank {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(validatorPipeline)
	return inst
}

// GetValidatorPipelineAccount gets the "validatorPipeline" account.
func (inst *Crank) GetValidatorPipelineAccount() *ag_solanago.AccountMeta {
...
func (inst *Crank) SetCrankerFundAccount(crankerFund ag_solanago.PublicKey) *Crank {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(crankerFund).WRITE()
	return inst
}
...
func (inst *Crank) SetCrankerAccount(cranker ag_solanago.PublicKey) *Crank {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(cranker).WRITE().SIGNER()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Crank")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=9]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      crankerFund", inst.AccountMetaSlice.Get(5)))
						accountsBranch.Child(ag_format.Meta("          cranker", inst.AccountMetaSlice.Get(6)))
